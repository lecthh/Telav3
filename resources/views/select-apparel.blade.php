        ...
        <div class="container text-start flex flex-col w-35 gap-y-4">
            <div class="flex justify-start mb-7 mt-10">
                <div class="flex gap-5">
                    <div
                        class="w-16 h-16 flex items-center justify-center text-black text-xl font-gilroy font-bold bg-cGreen rounded-full">
                        1</div>
                    <div
            ...
            <div class="text-black max-w-md">
                ...
                <p class="mt-4 font-inter text-start font-medium mx-auto">
                    Start by picking your favorite type and style of apparel. Whether it's a t-shirt, hoodie, or jersey,
                    we've got plenty of options to suit your needs!
                </p>
            </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 justify-center items-center mt-16" id="apparel-options">
            <div class="apparel-item border-2 bg-[#F3F3F3] border-gray-300 p-4 rounded-lg text-center hover:shadow-lg transition cursor-pointer"
                data-value="Jersey">
