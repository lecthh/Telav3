<div id="producer-registration" class="py-4">
    ...
    <form wire:submit.prevent="submit">
        ...
        <div class="mb-8 bg-gray-50 p-6 rounded-lg border border-gray-200">
            <h2 class="text-lg font-bold text-gray-800 mb-4">Business Documents</h2>
            ...
            <div class="mb-4 flex gap-4 items-center">
                <div class="flex-1">
                    ...
                    <input type="text" id="document-name-{{ $index }}" wire:model="documents.{{ $index }}.name"
                        class="mt-1 block w-full border-gray-300 rounded-md" placeholder="Enter document name">
                ...
                <div class="flex-1">
                    ...
                    <input type="file" id="document-file-{{ $index }}" wire:model="documents.{{ $index }}.file"
                        accept="image/*,application/pdf" class="mt-1 block w-full">
