@php
    $styles = [
        'primary' => 'flex bg-cPrimary rounded-xl text-white text-[18px] gap-y-3 px-6 py-3 justify-center transition ease-in-out hover:shadow-lg disabled:opacity-30 active:bg-[#6B10A8]',
        ...
        'greyed' => 'flex bg-[#9CA3AF] rounded-xl opacity-20 text-black gap-y-3 px-6 py-3 justify-center transition ease-in-out hover:shadow-md disabled:opacity-30 active:bg-gray-600',
