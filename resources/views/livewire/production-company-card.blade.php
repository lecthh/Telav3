<div>
    <div class="flex flex-col gap-y-6">
        ...
        <div class="flex gap-x-4 justify-start">
            ...
            <div
                class="flex flex-col gap-y-4 p-4 rounded-md bg-[#F4F4F4] cursor-pointer transition ease-in-out hover:shadow-lg {{ $selectedProductionCompany === $productionCompany->id ? 'border-2 border-purple-500' : 'border-gray-300' }}"
