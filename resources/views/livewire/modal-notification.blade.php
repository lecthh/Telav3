<div class="absolute z-50 flex h-[708px] w-[472px] flex-col gap-y-10 rounded-md bg-white px-6 py-7 drop-shadow-md" x-show="isOpen" x-cloak x-data="{ selected: 'all' }">
    ...
    <div class="flex flex-col gap-y-8">
        <div class="flex flex-col gap-y-8">
            <h3 class="font-inter font-bold text-base text-cDarkGrey">Today</h3>
                ...
                <div class="flex gap-x-4 px-2 py-3">
                    ...
                    <div class="flex flex-col gap-y-4">
                        <div class="flex flex-col gap-y-2">
                            <h3 class="font-gilroy font-bold text-base capitalize">Order Received</h3>
                            <h5 class="font-inter text-sm"><span>Order no. 8932</span> has been successfully placed and received by the producer</h5>
                        </div>
