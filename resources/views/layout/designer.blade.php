    ...
    <div class="py-4 px-2 flex-grow overflow-y-auto">
        <nav class="flex flex-col space-y-1">
            ...
            <div class="pt-4 mt-4 border-t border-gray-200">
                <a href="{{ route('partner.designer.profile.basics') }}" class="flex items-center gap-x-3 px-3 py-2.5 rounded-md {{ request()->routeIs('partner.designer.profile*') && !request()->routeIs('partner.designer.profile.reviews') ? 'bg-cGreen/20 text-cGreen font-medium' : 'text-gray-700 hover:bg-cGreen/10' }} transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
