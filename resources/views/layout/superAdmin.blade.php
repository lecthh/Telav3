<div class="flex flex-col border-r border-gray-200 h-full min-h-screen w-[280px] bg-white shadow-sm">
    ...
    <div class="py-4 px-2 flex-grow overflow-y-auto">
        <nav class="flex flex-col space-y-1">
            <a href="{{ route('superadmin.index') }}" class="flex items-center gap-x-3 px-3 py-2.5 rounded-md {{ request()->routeIs('printer-dashboard') ? 'bg-cAccent/20 text-cAccent font-medium' : 'text-gray-700 hover:bg-cAccent/10' }} transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            ...
            <a href="{{ route('superadmin.users') }}" class="flex items-center gap-x-3 px-3 py-2.5 rounded-md {{ (request()->routeIs('partner.printer.orders') || request()->routeIs('partner.printer.pending-order-x')) ? 'bg-cAccent/20 text-cAccent font-medium' : 'text-gray-700 hover:bg-cAccent/10' }} transition-colors">
            ...
            <a href="{{ route('superadmin.production') }}" class="flex items-center gap-x-3 px-3 py-2.5 rounded-md {{ request()->routeIs('partner.printer.printing*') ? 'bg-cAccent/20 text-cAccent font-medium' : 'text-gray-700 hover:bg-cAccent/10' }} transition-colors">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="{{ route('superadmin.designer') }}" class="flex items-center gap-x-3 px-3 py-2.5 rounded-md text-gray-700 hover:bg-cAccent/10 transition-colors">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
