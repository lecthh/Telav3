        ...
        <div class="container text-start flex flex-col w-35 gap-y-4">
            ...
            <div class="text-black max-w-xl">
                ...
                <p class="mt-4 font-inter text-start font-medium mx-auto">
                    Next, decide how you want your design to come to life. You can choose from methods like screen printing or embroidery—whatever best fits your vision!
                </p>
            </div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 justify-center items-center mt-16" id="production-options">
            <div class="production-item border-2 bg-[#F3F3F3] border-gray-300 p-4 rounded-lg text-center hover:shadow-lg transition cursor-pointer" data-value="Sublimation">
            ...
            <div class="production-item border-2 bg-[#F3F3F3] border-gray-300 p-4 rounded-lg text-center hover:shadow-lg transition cursor-pointer" data-value="Heat Transfer">
            ...
            <div class="production-item border-2 bg-[#F3F3F3] border-gray-300 p-4 rounded-lg text-center hover:shadow-lg transition cursor-pointer" data-value="Embroidery">
