                ...
                <div class="flex flex-col gap-y-5">
                    ...
                    <table class="table-auto min-w-full overflow-hidden rounded-lg animate-fade-in">
                        ...
                        <tbody class="border drop-shadow-sm">
                            ...
                            @else
                            @foreach($printingInProgress as $order)
                            <tr class="odd:bg-gray-100 even:bg-white hover:bg-cAccent hover:bg-opacity-10 cursor-pointer" data-url="{{ route('partner.printer.printing-x', ['order_id' => $order->order_id]) }}">
