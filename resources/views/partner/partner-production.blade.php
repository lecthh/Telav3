    ...
    <div class="flex flex-row gap-x-2.5">
        <div class="flex flex-col gap-y-[60px] px-[200px] py-[100px]">
            <div class="flex flex-col gap-y-6">
                ...
                <div class="flex flex-row gap-x-2.5 w-[1000px]">
                                ...
                                <div class="flex flex-col gap-y-4">
                                    ...
                                    <div class="flex flex-row gap-x-8">
                                        ...
                                        <div class="flex flex-row gap-x-2 items-center">
                                            <input type="radio" id="producer" name="role" value="producer" class="form-radio border border-black w-4 h-4 p-1 py-1 rounded-full checked:bg-cPrimary checked:hover:bg-cPrimary checked:active:bg-cPrimary checked:focus:bg-cPrimary focus:bg-cPrimary focus:outline-none focus:ring-1 focus:ring-cPrimary">
                        ...
                        <div class="flex flex-col gap-y-6 flex-grow">
                            <div class="flex flex-col gap-y-4">
                                ...
                                <div class="flex flex-col gap-y-2">
                                    <div class="flex flex-row gap-y-2.5 px-5 py-4 border border-black rounded-lg">
                                        <h3 class="font-inter text-base">EchoPoint Productions</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-row gap-x-6 justify-between">
                                ...
                                <div class="flex flex-col gap-y-4">
                                    ...
                                    <div class="flex flex-col gap-y-2">
                                        <div class="flex flex-row gap-y-2.5 px-5 py-4 border border-black rounded-lg">
                                            <h3 class="font-inter text-base">echopoint@gmail.com</h3>
                                        </div>
                                    </div>
                                </div>   
                                ...
                                <div class="flex flex-col gap-y-4">
                                    ...
                                    <div class="flex flex-col gap-y-2">
                                        <div class="flex flex-row gap-y-2.5 px-5 py-4 border border-black rounded-lg">
                                            <h3 class="font-inter text-base">+63 9270434532</h3>
                                        </div>
                                    </div>
                                </div>                           
                            </div> 
                            ...
                            <div class="flex flex-col gap-y-4">
                                ...
                                <div class="flex flex-col gap-y-2">
                                    <div class="flex flex-row gap-y-2.5 px-5 py-4 border border-black rounded-lg">
                                        <h3 class="font-inter text-base">541 Street</h3>
                                    </div>
                                </div>
                            </div>   
                            ...
                            <div class="flex flex-row gap-x-6 justify-between">
                                <div class="flex flex-col gap-y-4">
                                    ...
                                    <div class="flex flex-col gap-y-2">
                                        <div class="flex flex-row gap-y-2.5 px-5 py-4 border border-black rounded-lg h-[50px]">
