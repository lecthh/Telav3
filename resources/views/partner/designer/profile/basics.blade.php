                        ...
                        <div class="flex flex-col gap-y-6 w-full">
                            ...
                            <div class="flex flex-col gap-y-2">
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    class="px-4 py-3 border border-gray-300 rounded-md focus:ring-cGreen focus:border-cGreen w-full">{{ old('designer_description', $designer->designer_description) }}</textarea>
