            ...
            <div class="flex-1 p-6 overflow-auto">
                <div class="max-w-6xl mx-auto">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center mb-3">
                                    ...
                                    <div class="flex-grow h-4 bg-gray-100 rounded-full overflow-hidden">
                                        @if($reviewCount > 0)
                                        <div class="h-full bg-cGreen" style="width: {{ ($ratingDistribution[$i] / max($reviewCount, 1)) * 100 }}%"></div>
                                        @else
                    ...
                    <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                        ...
                        @if($designer->reviews->count() > 0)
                        <div class="divide-y divide-gray-100">
                            @foreach($designer->reviews as $review)
                            <div class="p-6">
                                <div class="flex items-start justify-between mb-4">
                                    <div class="flex items-start">
                                        <div class="mr-4 flex-shrink-0">
                                            <div class="w-12 h-12 bg-cGreen text-white rounded-full flex items-center justify-center text-xl font-bold">
                        ...
                        <div class="p-12 text-center">
                            ...
                            <p class="mt-2 text-gray-500">When customers leave reviews for your designs, they'll appear here.</p>
                        </div>
                        @endif
                    </div>
                </div>
