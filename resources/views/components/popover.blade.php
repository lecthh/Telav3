<div x-data="{ show: false }" class="relative inline-block" @mouseenter="show = true" @mouseleave="show = false" x-cloak wire:ignore>
    ...
    <div x-show="show"
        ...
        class="popover absolute bottom-full left-1/2 transform w-64 -translate-x-1/2 mb-2 px-2 py-1 bg-gray-100 font-medium
         text-black text-sm text-center rounded shadow border border-gray-200">
        {{ $slot }}
    </div>
</div>